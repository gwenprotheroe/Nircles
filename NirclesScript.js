...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const fileSizeColorScale = d3
    .scalePow()
    .exponent(0.1)
    .range(["#2B2A28", "#F2EFEC"]); //d3.scaleSequential(d3.interpolateBlues); // Using interpolateRainbow for all hues
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                type: "json",
                value: 5446,
                last_modified_unix: 1754352061.809732,
              ...
              },
              {
                ...
                type: "json",
                value: 15436,
                last_modified_unix: 1754352068.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
              },
              {
                path: "C:\\Demo\\See All\\Project 1",
                ...
                type: "jpg",
                value: 10546,
                last_modified_unix: 1754352062.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
              },
              {
                path: "C:\\Demo\\See All\\Project 1",
                ...
                type: "msg",
                value: 1086,
                last_modified_unix: 1754352091.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
              },
              {
                path: "C:\\Demo\\See All\\Project 1",
              ...
              },
              {
                ...
                type: "txt",
                value: 10146,
                last_modified_unix: 1754352161.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
              },
              {
                path: "C:\\Demo\\See All\\Project 1",
                ...
                type: "txt",
                value: 7096,
                last_modified_unix: 1754352001.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
              },
            ],
          },
          ...
          },
          {
            ...
            children: [
              {
                path: "C:\\Demo\\See All\\Project 3\\Don't look here",
                ...
                children: [
                  {
                    path: "C:\\Demo\\See All\\Project 3\\Don't look here\\Nothing to see",
                    name: "Nothing to see",
                    type: "folder",
                    value: "0",
                    last_modified_unix: 1754687390.5936754,
                    ...
                    children: [
                      {
                        path: "C:\\Demo\\See All\\Project 3\\Don't look here\\Nothing to see\\Seriously, don't look",
                        name: "Seriously, don't look",
                        type: "folder",
                        value: "0",
                        last_modified_unix: 1754687390.5936754,
                        last_modified_iso: "2025-08-08T22:09:50.593675",
                  ...
                  {
                    path: "C:\\Demo\\See All\\Project 3\\Don't look here\\Red Herring",
                    name: "Red Herring",
                    type: "folder",
                    value: "5000",
                    last_modified_unix: 1754687390.5936754,
              ...
              {
                path: "C:\\Demo\\See All\\Project 3",
                name: "Totally normal report.doc",
                type: "doc",
                value: 55486,
                last_modified_unix: 1754352061.709732,
                last_modified_iso: "2025-08-05T01:01:01.709732",
  ...
  function getNodeColor(d) {
    ...
    if (colorMode === "depth") {
      ...
      return d.data.last_modified_unix
        ? dateColorScale(d.data.last_modified_unix)
        : "#cccccc"; // Default grey if no date
    ...
    if (foundNode !== hoveredNode) {
      ...
      if (hoveredNode) {
        ...
        tooltip
          .style("opacity", 0.75)
          .html(
            `<strong> Item: </strong>${hoveredNode.data.name}
                            <br/><strong>Parent Folder: </strong>${
                              hoveredNode.parent
                                ? hoveredNode.parent.data.name
                                : ""
                            }
                            `
          )
    ...
    if (colorMode === "type") {
      ...
      fileTypes.forEach((type) => {
        ...
        legendItem.innerHTML = `
                        <span class="w-4 h-4 rounded-full" style="background-color: ${fileTypeColorScale(
                          type
                        )};"></span>
                            <span>.${type}</span>
                        `;
